...
transformer_name = 'ContrastTransform'
dataset_name = 'mmvp'
save_dir = '../result'
plot_degrees_in_same_transformer(image_directory, image_file, dataset_name, transformer_name, save_dir)


# Todo: the function to combine all transforms to the one picture together


# we can observe the difference easily

# 1.test different transformers in wider degrees and reduce their range
# 2.add some new transformers
# 3.README
